# Task 12 — Pagine Pubbliche Partite

**File da creare:**
- `app/(public)/greenvolley/partite/page.tsx`
- `app/(public)/greenvolley/partite/[id]/page.tsx`
...
- [ ] **Step 1: Crea `app/(public)/greenvolley/partite/page.tsx`**
...
- [ ] **Step 2: Crea `app/(public)/greenvolley/partite/[id]/page.tsx`**
...
```bash
git add app/(public)/greenvolley/partite/
git commit -m "feat: add GreenVolley public matches list and detail pages"
```
