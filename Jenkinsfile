                ...
                withCredentials([
                    ...
                    script {
                        ...
                        withEnv([
                            ...
                            sh 'docker compose run --rm -e DATABASE_URL="$APP_DATABASE_URL" -e NODE_ENV=development fantadc sh -c \'DATABASE_URL="$DATABASE_URL" NODE_ENV=development npx tsx prisma/seed-greenvolley.ts\''
