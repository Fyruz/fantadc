              ...
              return (
                ...
                >
                  {m.mvpPlayer.flagSrc ? (
                    ...
                    <div className="w-10 h-[27px] rounded flex items-center justify-center" style={{ background: "rgba(255,255,255,0.10)" }}>
                  ...
                  <div className="flex flex-col items-center gap-1 text-center">
                    <p className="text-xs text-white font-normal whitespace-nowrap truncate max-w-full">{m.mvpPlayer.name}</p>
