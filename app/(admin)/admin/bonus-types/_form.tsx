...
export default function NewBonusTypeForm() {
  ...
  return (
    <form action={action} className="flex gap-2 items-end flex-wrap border-t pt-4 mt-4">
      <div>
        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1">Codice *</label>
      ...
      <div>
        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1">Punti *</label>
